...
export function appointmentRequestView(request = {}) {
  return {
    ...
    dentistId: request.dentistId || request.dentist_id,
    dentistName: request.dentistName || request.dentist_name || '',
    requestedStartAt: request.requestedStartAt || request.requested_start_at,
    requestedEndAt: request.requestedEndAt || request.requested_end_at,
