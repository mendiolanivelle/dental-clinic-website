...
test('admin periods use equal previous windows and safe year-over-year dates', () => {
  ...
  assert.deepEqual(resolveAdminPeriod({}, now), {
    from: '2026-07-26', to: '2026-08-24', compare: 'previous_period',
    comparison: { from: '2026-06-26', to: '2026-07-25' },
    inProgress: true, refreshedAt: now.toISOString(),
  })
