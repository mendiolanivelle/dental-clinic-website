  ...
  app.put('/api/admin/social/settings', {
    ...
    schema: {
      body: {
        ...
        properties: {
          ...
          captionPrompt: { type: 'string', maxLength: 3000 },
          imagePrompt: { type: 'string', maxLength: 3000 },
    ...
    try {
      ...
      await store.updateSocialSettings({
        ...
        captionPrompt: request.body.captionPrompt.trim(),
        imagePrompt: request.body.imagePrompt.trim(),
